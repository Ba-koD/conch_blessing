...
-- -- Define ModCallbacks if not already defined
-- ModCallbacks = ModCallbacks or {
--     MC_NPC_UPDATE = 0,
--     MC_POST_UPDATE = 1,
--     MC_POST_RENDER = 2,
--     MC_USE_ITEM = 3,
...
--     MC_POST_TEAR_INIT = 40,
--     MC_POST_TEAR_RENDER = 41,
--     MC_POST_TEAR_UPDATE = 42,
...
--     MC_PRE_TEAR_COLLISION = 50,
--     MC_POST_KNIFE_INIT = 51,
--     MC_POST_KNIFE_UPDATE = 52,
--     MC_POST_KNIFE_RENDER = 53,
--     MC_PRE_KNIFE_COLLISION = 54,
--     MC_POST_ENTITY_REMOVE = 55,
--     MC_POST_EFFECT_INIT = 56,
--     MC_POST_EFFECT_UPDATE = 57,
--     MC_POST_EFFECT_RENDER = 58,
--     MC_POST_BOMB_INIT = 59,
--     MC_POST_BOMB_UPDATE = 60,
--     MC_POST_FIRE_TEAR = 61,
--     MC_POST_BOMB_RENDER = 62,
--     MC_PRE_BOMB_COLLISION = 63,
--     MC_PRE_GET_COLLECTIBLE = 64,
--     MC_POST_GET_COLLECTIBLE = 65,
--     MC_GET_PILL_COLOR = 66,
--     MC_GET_PILL_EFFECT = 67,
--     MC_GET_TRINKET = 68,
--     MC_POST_ENTITY_KILL = 69,
--     MC_PRE_NPC_UPDATE = 70,
--     MC_PRE_SPAWN_CLEAN_AWARD = 71,
--     MC_PRE_ROOM_ENTITY_SPAWN = 72,
--     MC_PRE_ENTITY_DEVOLVE = 73,
--     MC_PRE_MOD_UNLOAD = 74
-- }
